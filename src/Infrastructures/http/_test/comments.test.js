...
describe('/threads/{threadId}/comments endpoint', () => {
  ...
  describe('when DELETE /threads/{threadId}/comments/{commentId}', () => {
    it('should response 201 and delete comment successfully', async () => {
      ...
      await CommentsTableTestHelper.addComment({ id: commentId, thread: threadId });
    ...
    it('should response 403 when user is not an authorized owner of the comment', async () => {
      ...
      const anotherUserId = 'user-xxx';
      await UsersTableTestHelper.addUser({ id: anotherUserId, username: 'user-xxx' });
      ...
      await CommentsTableTestHelper.addComment({
        id: commentId, thread: threadId, owner: anotherUserId,
      });
